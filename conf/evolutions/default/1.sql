...
create table "user" ("uuid" VARCHAR NOT NULL PRIMARY KEY,"barNumber" INTEGER NOT NULL,"firstName" VARCHAR,"lastName" VARCHAR,"fullName" VARCHAR,"email" VARCHAR,"avatarURL" VARCHAR);
create table "userlogininfo" ("uuid" VARCHAR NOT NULL,"loginInfoId" BIGINT NOT NULL);
